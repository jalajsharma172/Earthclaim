...
export default function MyListedItems({ marketplace, nft, account }) {
    ...
    if (loading) {
        return (<div className="d-flex justify-content-center align-items-center min-vh-50">
    ...
    return (<div className="my-listed-items-container">
            ...
            {listedItems.length > 0 ? (<div className="container-fluid px-4">
                    {/* Stats Overview */}
                    ...
                    <div className="listed-section">
                        ...
                        {listedItems.filter(item => !soldItems.includes(item)).length > 0 ? (<Row xs={1} md={2} lg={4} className="g-4">
                                {listedItems.filter(item => !soldItems.includes(item)).map((item, idx) => (<Col key={idx} className="overflow-hidden">
                            ...
                            </Row>) : (<Alert variant="info" className="text-center">
                ...
                </div>) : (<div className="empty-state text-center py-5">
