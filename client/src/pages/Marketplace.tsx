  ...
  return (
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="container mx-auto px-4">
        ...
        {items.length > 0 ? (
          <div className="bg-gray-800 bg-opacity-50 rounded-lg border border-cyan-400 p-6">
            {/* Stats Bar */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {items.map((it, idx) => (
                <div 
                  key={idx} 
                  className="bg-gray-800 rounded-lg border border-gray-600 hover:border-cyan-400 transition-all duration-300 hover:scale-105 cursor-pointer group"
                  onClick={() => {
          ...
          <div className="text-center py-16">
            <div className="bg-gray-800 bg-opacity-50 rounded-lg border border-cyan-400 p-8 max-w-2xl mx-auto">
              ...
              <button 
                ...
                className="bg-cyan-600 hover:bg-cyan-500 text-white font-mono px-6 py-3 rounded border border-cyan-400 transition-colors"
              >
                CREATE FIRST NFT
              </button>
            </div>
