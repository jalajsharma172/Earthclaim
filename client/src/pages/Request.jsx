...
export default function Request({ marketplace, nft }) {
    ...
    const handleSendRequest = async (e) => {
        ...
        try {
            ...
            // For example:
            const tx = await marketplace.proposeExchange(leftForm.nftContractAddress, leftForm.nftTokenId, rightForm.nftContractAddress, rightForm.nftTokenId, rightForm.userAddress);
            await tx.wait();
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gray-800 bg-opacity-50 rounded-lg border border-cyan-400 p-6 relative">
              ...
              <div className="bg-gray-900 rounded-lg border border-cyan-400 p-6 relative">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" placeholder="0x..." value={leftForm.nftContractAddress} onChange={(e) => setLeftForm(prev => ({ ...prev, nftContractAddress: e.target.value }))} disabled={isLoading} className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono placeholder-gray-500 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-50 transition-all duration-300 disabled:opacity-50"/>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Enter token ID" value={leftForm.nftTokenId} onChange={(e) => setLeftForm(prev => ({ ...prev, nftTokenId: e.target.value }))} disabled={isLoading} className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono placeholder-gray-500 focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400 focus:ring-opacity-50 transition-all duration-300 disabled:opacity-50"/>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-900 rounded-lg border border-purple-400 p-6 relative">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input type="text" placeholder="0x..." value={rightForm.nftContractAddress} onChange={(e) => setRightForm(prev => ({ ...prev, nftContractAddress: e.target.value }))} disabled={isLoading} className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono placeholder-gray-500 focus:border-purple-400 focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50 transition-all duration-300 disabled:opacity-50"/>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Enter token ID" value={rightForm.nftTokenId} onChange={(e) => setRightForm(prev => ({ ...prev, nftTokenId: e.target.value }))} disabled={isLoading} className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono placeholder-gray-500 focus:border-purple-400 focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50 transition-all duration-300 disabled:opacity-50"/>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="0x..." value={rightForm.userAddress} onChange={(e) => setRightForm(prev => ({ ...prev, userAddress: e.target.value }))} disabled={isLoading} className="w-full bg-gray-800 border border-gray-600 rounded-lg px-4 py-3 text-white font-mono placeholder-gray-500 focus:border-purple-400 focus:ring-2 focus:ring-purple-400 focus:ring-opacity-50 transition-all duration-300 disabled:opacity-50"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8 pt-6 border-t border-gray-600">
              <button type="button" onClick={clearForms} disabled={isLoading} className="flex-1 bg-gray-700 hover:bg-gray-600 text-white font-mono py-3 px-6 rounded-lg border border-gray-500 hover:border-gray-400 transition-all duration-300 disabled:opacity-50 flex items-center justify-center">
                <span className="mr-2">🗑️</span>
                CLEAR ALL
              </button>
              
              <button onClick={handleSendRequest} disabled={isLoading} className="flex-1 bg-cyan-600 hover:bg-cyan-500 text-white font-mono py-3 px-6 rounded-lg border border-cyan-400 hover:border-cyan-300 transition-all duration-300 disabled:opacity-50 flex items-center justify-center">
                {isLoading ? (<>
