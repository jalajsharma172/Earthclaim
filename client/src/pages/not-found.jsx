...
export default function NotFound() {
    ...
    return (<div className="min-h-screen w-full flex items-center justify-center bg-gray-900 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md mx-4 relative z-10 bg-gray-800/80 backdrop-blur-md border-cyan-400/50 border-2 shadow-[0_0_30px_rgba(6,182,212,0.3)]">
        ...
        <CardContent className="pt-8 pb-8 text-center">
          ...
          <button onClick={() => navigate('/')} className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold font-mono py-3 px-8 rounded-lg transition-all duration-300 shadow-[0_0_20px_rgba(6,182,212,0.4)] hover:shadow-[0_0_30px_rgba(6,182,212,0.6)] border border-cyan-400/50">
            🏠 RETURN TO BASE
          </button>
