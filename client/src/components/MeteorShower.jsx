...
const MeteorShower = () => {
    ...
    return (<div className="absolute inset-0 pointer-events-none z-20 overflow-hidden">
            {meteors.map((el, idx) => (<span key={idx} className="absolute top-0 left-1/2 w-0.5 h-0.5 bg-slate-100 shadow-[0_0_0_1px_#ffffff10] rotate-[215deg] animate-meteor" style={{
                top: 0,
