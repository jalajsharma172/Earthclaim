...
const NFTPolygonViewer = () => {
        ...
        const displayPolygon = async () => {
            ...
            try {
                ...
                const valid = Array.isArray(coordinates) &&
                    ...
                    coordinates.every(point => typeof point.lat === 'number' &&
                ...
                markersRef.current = [];
                // Map coordinates
                const latLngs = coordinates.map(point => [point.lat, point.lon]);
                // Add polygon
    ...
    return (<div className="h-screen w-full flex flex-col">
      ...
      <div className="bg-white shadow-md p-4 z-10 flex items-center justify-between">
        <button onClick={() => navigate(-1)} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors flex items-center gap-2">
          ← Back
        </button>
      ...
      <div className="relative flex-1">
        ...
        {loading && (<div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        ...
        {error && (<div className="absolute top-4 left-4 right-4 flex justify-center">
